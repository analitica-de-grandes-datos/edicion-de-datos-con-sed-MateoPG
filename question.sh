...
#
cat data.csv | sed 's/\([0-9][0-9]\)\/\([0-9][0-9]\)\/\([0-9][0-9]\)/20\3-\2-\1/' | sed 's/\([0-9]\)\/\([0-9]\)\/\([0-9]*\)/\3-0\2-0\1/' | sed 's/,/./g'| sed 's/;/,/g'| sed 's/,,/,\\N,/g'| sed 's/n/\N/g'| sed 's/a/A/g'| sed 's/c/C/g'| sed 's/\,$/\,\N/'| sed 's/,N/,\\N/g'
